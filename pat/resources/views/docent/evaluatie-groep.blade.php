<div class="container mt-5">
    ...
    <a href="{{ route('evaluatie.groepen', $evaluatie->id) }}" class="btn btn-secondary mb-3">Terug naar groepen</a>
        ...
        <tbody>
            @foreach($groep->studenten as $student)
                ...
                <tr>
                    ...
                    <td>
                        {{ $ontvangenCount > 0 ? number_format($ontvangen / $ontvangenCount, 2) : '-' }}
                    </td>
                    <td>{{ $gegeven !== 0 ? number_format($gegeven, 2) : '-' }}</td>
                    <td>
                        {{ $gegevenCount > 0 ? number_format($gegeven / $gegevenCount, 2) : '-' }}
                    </td>
                </tr>
            @endforeach
        </tbody>
