...
Route::post('/studenten-klas', [ImportController::class, 'importStudents'])
...
Route::post('/api/studenten-groepen', [ImportGroepenController::class, 'store'])->middleware('auth');
Route::post('/studenten-groepen', [ImportGroepenController::class, 'importStudentGroups'])->middleware('auth', DecompressRequest::class);
